...
import { CartEmpty, CartItem } from "../componenrs";
import { clearCart, removeCart, addPizzaCart, minusPizza } from "../redux/action/cart";
                ...
                <div className="cart">
                    ...
                    <div className="content__items">
                        {pizzas.map(obj => (
                            <CartItem
                                ...
                                obj={obj}
                                {...obj}
                                totalPrice={items[obj.id].totalPriceItem}
                    ...
                    <div className="cart__bottom">
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <div onClick={onOrderPizzas} className="button pay-btn">
